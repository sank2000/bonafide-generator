...
Font.register({ family: 'TimesNewRoman', src: '/font/times.ttf' });
Font.register({ family: 'TimesNewRoman', src: '/font/times-bold.ttf', fontWeight: 'bold' });
			...
			<View style={styles.content}>
				...
				<View>
					<Text style={{ ...styles.contentText, textIndent: '50px' }}>
						...
						{data.registerNo}) is a bonafide student of the University College of Engineering
						(Bharathidasan Institute of Technology (BIT) Campus, Anna university) Tiruchirappalli
						and he is doing <span style={styles.bold}>II year {data.degree}</span> programme in the
						branch of <span style={styles.bold}>{data.department} </span>
					...
					<Text style={{ ...styles.contentText, margin: '20 0' }}>
						...
						<span style={{ textDecoration: 'underline' }}>
							{format(new Date(data.createdDate), 'dd - LL - yyyy')}
						</span>
						.
					</Text>
				</View>
